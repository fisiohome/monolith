...
import { Check, ChevronLeft, ChevronsUpDown, Eye, EyeClosed } from "lucide-react";
	...
	function onSubmit(values: z.infer<typeof formSchema>) {
		...
		router.post(
			...
			deepTransformKeysToSnakeCase({
				...
				user: { email: values.email, password: values.password, passwordConfirmation: values.passwordConfirmation }
			})
		)
				...
				<div className="space-y-6 lg:w-6/12">
					<div className="flex items-center gap-4">
						<div className="flex items-center gap-2">
							...
							<Separator orientation="vertical" className="h-5 bg-muted-foreground/50" />
						</div>
					...
					<Form {...form}>
						<form onSubmit={form.handleSubmit(onSubmit)} className="grid space-y-4 lg:w-8/12">
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input {...field} type="text" placeholder="Enter the name..." />
										</FormControl>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input {...field} type="email" placeholder="Enter the email..." />
										</FormControl>
									...
									<FormItem>
										...
										<FormControl>
											<div className="relative">
												...
												>
													{!passwordConfirmationVisibility ? <Eye className="size-4" /> : <EyeClosed className="size-4" />}
													<span className="sr-only">Toggle Password Visibility</span>
												</Button>
											</div>
										</FormControl>
